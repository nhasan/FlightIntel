 ...
 * Portions Copyright (C) 2012 Nadeem Hasan <nhasan@nadmm.com>
 *
...
public class Consts {
    ...
    public static final String ACTION_CONFIRM_NOTIFICATION =
        "com.nadmm.airports.CONFIRM_NOTIFICATION";
    public static final String ACTION_GET_PURCHASE_INFORMATION =
        "com.nadmm.airports.GET_PURCHASE_INFORMATION";
    public static final String ACTION_RESTORE_TRANSACTIONS =
        "com.nadmm.airports.RESTORE_TRANSACTIONS";
    ...
    public static final String BILLING_METHOD_CHECK_BILLING_SUPPORTED = "CHECK_BILLING_SUPPORTED";
    public static final String BILLING_METHOD_REQUEST_PURCHASE = "REQUEST_PURCHASE";
    public static final String BILLING_METHOD_GET_PURCHASE_INFORMATION = "GET_PURCHASE_INFORMATION";
    public static final String BILLING_METHOD_CONFIRM_NOTIFICATIONS = "CONFIRM_NOTIFICATIONS";
    public static final String BILLING_METHOD_RESTORE_TRANSACTIONS = "RESTORE_TRANSACTIONS";
