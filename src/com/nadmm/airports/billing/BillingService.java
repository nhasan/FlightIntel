...
import com.nadmm.airports.billing.Security.VerifiedPurchase;
...
public class BillingService extends Service implements ServiceConnection {
    ...
    class CheckBillingSupported extends BillingRequest {
        ...
        protected long run() throws RemoteException {
            Bundle request = makeRequestBundle( Consts.BILLING_METHOD_CHECK_BILLING_SUPPORTED );
    ...
    class ConfirmNotifications extends BillingRequest {
        ...
        @Override
        protected long run() throws RemoteException {
            Bundle request = makeRequestBundle( Consts.BILLING_METHOD_CONFIRM_NOTIFICATIONS );
    ...
    class GetPurchaseInformation extends BillingRequest {
        ...
        protected long run() throws RemoteException {
            ...
            Bundle request = makeRequestBundle( Consts.BILLING_METHOD_GET_PURCHASE_INFORMATION );
    ...
    public class RestoreTransactions extends BillingRequest {
        ...
        protected long run() throws RemoteException {
            ...
            Bundle request = makeRequestBundle( Consts.BILLING_METHOD_RESTORE_TRANSACTIONS );
            request.putLong( NONCE, mNonce );
            Bundle response = mService.sendBillingRequest( request );
            logResponseCode( getClass().getSimpleName(), response );
            return response.getLong( Consts.BILLING_RESPONSE_REQUEST_ID,
                    Consts.BILLING_RESPONSE_INVALID_REQUEST_ID );
        }
        ...
        @Override
        protected void responseCodeReceived( ResponseCode responseCode ) {
            Log.d( getClass().getSimpleName(), responseCode.toString() );
            ResponseHandler.responseCodeReceived( BillingService.this, this, responseCode );
        }
    }
