...
public class ResponseHandler {
    ...
    public static void purchaseResponse( final Context context, final PurchaseState purchaseState,
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                db.updateDonation( orderId, productId, purchaseState, purchaseTime );
                db.close();
                ...
                synchronized( ResponseHandler.class ) {
                    if ( sPurchaseObserver != null ) {
                        sPurchaseObserver.postPurchaseStateChange(
                                purchaseState, productId, 1, purchaseTime, null );
                    }
                }
            }
        }).start();
    ...
    public static void responseCodeReceived(Context context, RestoreTransactions request,
            ResponseCode responseCode) {
        Log.d( "RestoreTransactions", responseCode.toString() );
        if (sPurchaseObserver != null) {
